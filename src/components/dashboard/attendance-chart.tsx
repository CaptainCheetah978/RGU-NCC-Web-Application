    ...
    return (
        <Card className="bg-white/80 dark:bg-slate-800/80 blur-backdrop border-gray-100 dark:border-slate-700/60 shadow-sm">
            <CardHeader className="pb-2">
                ...
                <p className="text-xs text-gray-700 dark:text-slate-400 mt-1 font-bold italic">Per-class attendance breakdown</p>
            </CardHeader>
            <CardContent>
                {data.length === 0 ? (
                    <div className="py-12 text-center text-gray-500 dark:text-slate-400 font-medium">
                    ...
                    <div className="space-y-4">
                        {/* Legend */}
                        <div className="flex items-center space-x-4 text-[10px] font-bold uppercase tracking-wider text-gray-700 dark:text-slate-400">
                            <span className="flex items-center"><span className="w-2.5 h-2.5 rounded-sm bg-green-700 mr-1.5" />Present</span>
                            <span className="flex items-center"><span className="w-2.5 h-2.5 rounded-sm bg-red-700 mr-1.5" />Absent</span>
                            <span className="flex items-center"><span className="w-2.5 h-2.5 rounded-sm bg-amber-600 mr-1.5" />Late</span>
                            <span className="flex items-center"><span className="w-2.5 h-2.5 rounded-sm bg-gray-600 mr-1.5" />Excused</span>
                        </div>
                                ...
                                return (
                                    <div key={i}>
                                        <div className="flex items-center justify-between mb-1">
                                            ...
                                            <span className="text-[10px] text-gray-600 dark:text-slate-400 font-bold">{total} records</span>
                                        </div>
                                        <div className="h-6 rounded-lg bg-gray-100 dark:bg-slate-700/60 overflow-hidden flex">
                                            {item.present > 0 && (
                                                <div
                                                    className="h-full bg-green-700 transition-all duration-500 flex items-center justify-center"
                                            ...
                                            {item.absent > 0 && (
                                                <div
                                                    className="h-full bg-red-700 transition-all duration-500 flex items-center justify-center"
                                            ...
                                            {item.late > 0 && (
                                                <div
                                                    className="h-full bg-amber-600 transition-all duration-500 flex items-center justify-center"
                                            ...
                                            {item.excused > 0 && (
                                                <div
                                                    className="h-full bg-gray-600 transition-all duration-500 flex items-center justify-center"
